  ...
  return (
    <div className="home">
      ...
      <section className="home-section">
        ...
        <p>
          Установи расширение <a href="https://github.com/mtferma/keynest-extension" target="_blank" rel="noopener noreferrer">Keynest для Chrome</a> . Оно автоматически предложит надёжный пароль при регистрации на сайтах. Все пароли хранятся локально в твоём браузере — никаких внешних серверов, никакого риска утечки данных.
        </p>
      </section>
